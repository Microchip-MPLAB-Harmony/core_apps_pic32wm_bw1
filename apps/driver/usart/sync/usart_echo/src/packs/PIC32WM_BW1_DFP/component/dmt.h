...
#ifndef _002_DMT_COMPONENT_H_
#define _002_DMT_COMPONENT_H_
...
#define DMT_DMTSTAT_BAD(value)                (DMT_DMTSTAT_BAD_Msk & (_UINT32_(value) << DMT_DMTSTAT_BAD_Pos)) /* Assignment of value for BAD in the DMT_DMTSTAT register */
