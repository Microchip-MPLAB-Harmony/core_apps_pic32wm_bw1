...
#ifndef _002_PMU_COMPONENT_H_
#define _002_PMU_COMPONENT_H_
...
#define PMU_CLKCTRL_WLDOOFF(value)            (PMU_CLKCTRL_WLDOOFF_Msk & (_UINT32_(value) << PMU_CLKCTRL_WLDOOFF_Pos)) /* Assignment of value for WLDOOFF in the PMU_CLKCTRL register */
...
#define PMU_CLKCTRL_WCMRET(value)             (PMU_CLKCTRL_WCMRET_Msk & (_UINT32_(value) << PMU_CLKCTRL_WCMRET_Pos)) /* Assignment of value for WCMRET in the PMU_CLKCTRL register */
...
#define PMU_WCMCMD_WCMADDR(value)             (PMU_WCMCMD_WCMADDR_Msk & (_UINT32_(value) << PMU_WCMCMD_WCMADDR_Pos)) /* Assignment of value for WCMADDR in the PMU_WCMCMD register */
...
#define PMU_WCMCMD_WCMCLKDIV(value)           (PMU_WCMCMD_WCMCLKDIV_Msk & (_UINT32_(value) << PMU_WCMCMD_WCMCLKDIV_Pos)) /* Assignment of value for WCMCLKDIV in the PMU_WCMCMD register */
...
#define PMU_WCMCMD_WCMRDU(value)              (PMU_WCMCMD_WCMRDU_Msk & (_UINT32_(value) << PMU_WCMCMD_WCMRDU_Pos)) /* Assignment of value for WCMRDU in the PMU_WCMCMD register */
...
#define PMU_WCMCMD_CMD(value)                 (PMU_WCMCMD_CMD_Msk & (_UINT32_(value) << PMU_WCMCMD_CMD_Pos)) /* Assignment of value for CMD in the PMU_WCMCMD register */
...
#define PMU_WCMCMD_MODE(value)                (PMU_WCMCMD_MODE_Msk & (_UINT32_(value) << PMU_WCMCMD_MODE_Pos)) /* Assignment of value for MODE in the PMU_WCMCMD register */
...
#define PMU_WCMWDATA_WCMWDATA(value)          (PMU_WCMWDATA_WCMWDATA_Msk & (_UINT32_(value) << PMU_WCMWDATA_WCMWDATA_Pos)) /* Assignment of value for WCMWDATA in the PMU_WCMWDATA register */
...
#define PMU_WCMRDATA_WCMRDATA(value)          (PMU_WCMRDATA_WCMRDATA_Msk & (_UINT32_(value) << PMU_WCMRDATA_WCMRDATA_Pos)) /* Assignment of value for WCMRDATA in the PMU_WCMRDATA register */
