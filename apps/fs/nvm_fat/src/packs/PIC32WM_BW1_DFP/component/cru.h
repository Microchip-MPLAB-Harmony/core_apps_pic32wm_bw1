...
#define CRU_CLKDIAG_SPLL2STOP(value)          (CRU_CLKDIAG_SPLL2STOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_SPLL2STOP_Pos)) /* Assignment of value for SPLL2STOP in the CRU_CLKDIAG register */
