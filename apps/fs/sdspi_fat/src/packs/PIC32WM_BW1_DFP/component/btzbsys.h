...
#ifndef _002_BTZBSYS_COMPONENT_H_
#define _002_BTZBSYS_COMPONENT_H_
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_subsys_bypass_xtal_ready(value) (BTZBSYS_SUBSYS_CNTRL_REG1_subsys_bypass_xtal_ready_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_subsys_bypass_xtal_ready_Pos)) /* Assignment of value for subsys_bypass_xtal_ready in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_subsys_bypass_pll_lock(value) (BTZBSYS_SUBSYS_CNTRL_REG1_subsys_bypass_pll_lock_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_subsys_bypass_pll_lock_Pos)) /* Assignment of value for subsys_bypass_pll_lock in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#endif /* _002_BTZBSYS_COMPONENT_H_ */
