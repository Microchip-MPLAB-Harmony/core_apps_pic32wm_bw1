...
#ifndef _002_ARB_COMPONENT_H_
#define _002_ARB_COMPONENT_H_
...
#define ARB_CORE_CTRL_Reserved(value)         (ARB_CORE_CTRL_Reserved_Msk & (_UINT32_(value) << ARB_CORE_CTRL_Reserved_Pos)) /* Assignment of value for Reserved in the ARB_CORE_CTRL register */
